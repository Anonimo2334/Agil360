    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img class="dark:hidden" src="{{ asset('images/logo/agil-logo.png') }}" alt="Logo" width="100" />
                <img class="hidden dark:block" src="{{ asset('images/logo/agil-logo.png') }}" alt="Logo" width="100" />
            </a>
