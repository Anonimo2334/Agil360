...
@php
    ...
    $menuGroups = MenuHelper::getMenuGroups(auth()->user());
    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/">
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="dark:hidden" src="{{ asset('images/logo/agil-logo.png') }}" alt="Logo" width="150" height="auto" />
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="hidden dark:block" src="{{ asset('images/logo/agil-logo.png') }}" alt="Logo" width="150"
                height="auto" />
            <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                src="{{ asset('images/logo/agil-logo-icon.png') }}" alt="Logo" width="32" height="auto" />
