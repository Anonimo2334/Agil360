            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                <div class="mx-auto w-full max-w-md pt-10">
                    <div class="flex items-center gap-2">
                        <img src="{{ asset('images/logo/agil-logo.png') }}" alt="Logo" class="h-10 w-auto">
                    </div>
                </div>
                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Ingresa tus credenciales para acceder a Agil365.
                            </p>
                        </div>
                        <div>
                            @if ($errors->any())
                                <div class="mb-4 p-4 bg-error-50 border border-error-200 rounded-lg dark:bg-error-500/10 dark:border-error-500/20">
                            ...
                            @endif
                            @if (session('success'))
                                <div class="mb-4 p-4 bg-success-50 border border-success-200 rounded-lg dark:bg-success-500/10">
                            ...
                            <form method="POST" action="{{ route('signin.post') }}">
                                <div class="space-y-5">
                                    ...
                                    <!-- Checkbox -->
                                    <div class="flex items-center justify-between" x-data="{checkboxToggle:false}">
                                        <div>
                                            <label for="remember"
                                                class="flex cursor-pointer items-center text-sm font-normal text-gray-700 select-none dark:text-gray-400">
                                                <input type="checkbox" id="remember" name="remember" class="mr-2 rounded border-gray-300 text-brand-500 focus:ring-brand-500" />
                                                Mantener sesión
                                            </label>
                                        </div>
            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <div class="mb-6">
                            <img src="{{ asset('images/logo/agil-logo.png') }}" alt="Logo" class="h-20 w-auto">
                        </div>
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Gestión de proyectos tecnológicos, cuentas, ingenieros y operaciones en tiempo real.
                        </p>
                    </div>
                </div>
            </div>
